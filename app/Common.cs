...
namespace LuaFlux
{
  ...
  {
    internal static string TodosFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "LuaFlux", "todos.json");
    internal static string SettingsFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "LuaFlux", "settings.json");
